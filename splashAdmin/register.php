        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="post" action="action.php" id="registerForm" name="registerForm">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="userFullName" name="userFullName" placeholder="Full Name">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  ...
                  <!--div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="userConfirmPassword" name="userConfirmPassword" placeholder="Repeat Password">
                  </div-->
                </div>
